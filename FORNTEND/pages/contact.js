...
export default function contact() {
    ...
    async function createProduct(ev) {
        ...
        const data = { fname, lname, email, company, phone, country, project, price, description }
                    ...
                    <div className="leftcontp">
                        ...
                        <div className="leftsociinfo">
                            <ul>
                                ...
                                <li><MdAttachEmail /> <span>Email: <a href="mailto:jirakid2002@gmail.com" target="_blank">jirakid2002@gmail.com</a></span></li>
                                <li><GrLinkedin /> <span>Linkedin: <a href="tel:+123456789" target="_blank">+91-123456789</a></span></li>
                                <li><FaTwitter /> <span>Twitter: <a href="tel:+123456789" target="_blank">@canyoucallinamo</a></span></li>
                            </ul>
                        </div>
                    </div>
                    <div className="rightcontp">
                        <form onSubmit={createProduct}>
                            ...
                            <div className="rightcontinputs">
                                <input type="text" value={fname} onChange={ev => setFname(ev.target.value)} placeholder="First name" required />
