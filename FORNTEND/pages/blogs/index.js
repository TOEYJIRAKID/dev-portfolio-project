                ...
                <div className="container">
                    <div className="toptitle">
                        <div className="toptitlecont flex">
                            <h1>Welcome to <span>ToeyJira Blogs!</span></h1>
                        ...
                        <div className="border">
                            <div className="featuredposts">
                                ...
                                <div className="feposts flex">
                                    <Swiper slidesPerView={'auto'} freeMode={true} spaceBetween={30} className='mySwiper' modules={[FreeMode]}>
                                        {loading ? <Spinner /> : <>
                                                        ...
                                                        <div className="fpostinfo">
                                                            <div className="tegs flex">
                                                                {blog.blogcategory.map((cat) => {
                                                                    return <Link href={`/blog/category${cat}`} className='ai'>
                                                                        <span></span>{cat}
                                                                    </Link>
                                                                })}
                                                            </div>
                    ...
                    <div className="populartegsdata">
                        ...
                        <div className="poputegs">
                            <Link href='/blog/category/Next JS' className='pteg'>
                                <img src="https://images-cdn.openxcell.com/wp-content/uploads/2024/07/24154156/dango-inner-2.webp" alt="nextjs" />
                                <div className="tegs">
                                    <div className="apps"><span></span>Next JS</div>
                                </div>
                            </Link>
                            <Link href='/blog/category/Node JS' className='pteg'>
                                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2F1.bp.blogspot.com%2F-sqAjIvOtpXI%2FXYoCmqOyMwI%2FAAAAAAAAJig%2FCowR8wgEauEs-RXN2IPmLYkC7NHoHuA3gCLcBGAsYHQ%2Fs1600%2Fnode-js-logo.png&f=1&nofb=1&ipt=150fc0483e4465a22a3e277c4648396630b73d7dd21249b50e0f27b5753e8e4f&ipo=images" alt="nodejs" />
                                <div className="tegs">
                                    <div className="apps"><span></span>Node JS</div>
                                </div>
                            </Link>
                            <Link href='/blog/category/React JS' className='pteg'>
                                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia2.giphy.com%2Fmedia%2FeNAsjO55tPbgaor7ma%2Fsource.gif&f=1&nofb=1&ipt=1b6c2d1f4493f3ac96918899cd5c25eeec185ba33f30d800552d9b6a6655a8c7&ipo=images" alt="reactjs" />
                                <div className="tegs">
                                    <div className="apps"><span></span>React JS</div>
                                </div>
                            </Link>
                            <Link href='/blog/category/Digital Marketing' className='pteg'>
                                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.bandt.com.au%2Finformation%2Fuploads%2F2016%2F06%2Fwhat-is-digital-marketing.jpg&f=1&nofb=1&ipt=656563f849714c46144b621537bf85f7ac8acb506678f5b0679879dd602bb9b4&ipo=images" alt="digital" />
                                <div className="tegs">
                                    <div className="apps"><span></span>Digital</div>
                                </div>
                            </Link>
                            <Link href='/blog/category/Flutter Dev' className='pteg'>
                                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fscholar.fidahasan.com%2Fwp-content%2Fuploads%2F2019%2F11%2Fflutter-logo.png&f=1&nofb=1&ipt=2ea4dd59087272499663573c42b9fce58916ac50f20c7186946de0ffc23acfe1&ipo=images" alt="flutter" />
                                <div className="tegs">
                                    <div className="apps"><span></span>Flutter</div>
                                </div>
                            </Link>
                            <Link href='/blog/category/Tailwind CSS' className='pteg'>
                                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fd6f6d0kpz0gyr.cloudfront.net%2Fuploads%2Fimages%2F_1200x630_crop_center-center_82_none%2Ftailwind-thumb.jpg%3Fmtime%3D1609771799&f=1&nofb=1&ipt=7905bdb27cec8eef124c91d0809bea12a463ac5d375240e052349785be22fbb9&ipo=images" alt="tailwind" />
                                <div className="tegs">
